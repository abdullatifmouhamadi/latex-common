...
\fancyhead[R]{
  ...
  \fancyfoot[C]{}
  \fancyfoot[R]{
    \textcolor{general@best@blue}{HOTEL DIWA PROJET GESTION D’UN HOTEL} 
    \textcolor{general@best@gray}{| Combani commune de Tsingoni}
  }%
}
\pagestyle{plain}
...
\newcommand{\basepagea}[5]{
  \begin{titlepage}
    \begin{tikzpicture}
        ...
        \node(boundbox) [fill=white,scale=1.3,draw=gray!25,xshift=10.775cm] (logoscope){
            \logoMDC
          };
    \end{tikzpicture}
    ...
    \begin{minipage}{0.40\textwidth} %right column
        \Large \textbf{Application de gestion d’hôtel}
