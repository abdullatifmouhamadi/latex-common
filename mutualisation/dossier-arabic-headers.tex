...
\newcommand{\lexiquea}[1]{%
  \begin{longtable}{|R{.3\textwidth}|L{.4\textwidth}|R{.2\textwidth}|}
    \hline 
    \rowcolor{general@best@orange} \textbf{\textcolor{white}{mot arabe}} &  \textbf{\textcolor{white}{traduction}} &  \textbf{\textcolor{white}{racine}} \\\hline
    #1
    \hline
  \end{longtable}
}
