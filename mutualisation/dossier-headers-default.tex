...
\def\imgdescacolor{general@best@fuchsia}
...
\newcommand{\imgdescatag}[2]{%
  \node[white, circle,draw,fill=\imgdescacolor, ultra thick] at #1 {\bfseries #2};
}
...
\newcommand{\bubblec}[1]{
  \begin{tikzpicture}
    \node[fill=general@best@maroon,rounded corners]
    {\textcolor{white}{\bfseries#1}};
    \end{tikzpicture}
}