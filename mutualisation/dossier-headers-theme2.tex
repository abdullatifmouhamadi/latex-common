...
\titleformat{\section}
  {\Large\bfseries\sffamily\color{general@best@green}}
  {\SectionNumberBox{section}{general@best@green}}
  {0pt}
  {\formatSection}
  ...
  \newcommand{\formatChapter}[1]{%
    \begin{tikzpicture}[remember picture,overlay]
      \node[yshift=-3cm] at (current page.north west)
        {\begin{tikzpicture}[remember picture, overlay]
          \draw[fill=general@best@olive] (0,0) rectangle
            (\paperwidth,3cm);
          \node[anchor=east,xshift=.9\paperwidth,rectangle,
                rounded corners=2pt,inner sep=11pt,
                fill=general@best@olive!80]
...
\newcommand{\parttoccolor}{general@best@olive}
\newcommand{\chaptertoccolor}{general@best@olive}
\newcommand{\sectiontoccolor}{general@best@green}
