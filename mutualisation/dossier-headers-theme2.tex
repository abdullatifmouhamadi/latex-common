...
\titleformat{\section}
  {\Large\bfseries\sffamily\color{general@best@teal}}
  {\SectionNumberBox{section}{general@best@teal}}
  {0pt}
  {\formatSection}
\titleformat{\subsection}
  {\large\bfseries\sffamily\color{general@best@orange}}
  {\SectionNumberBox{subsection}{general@best@orange}}
  {0pt}
  {\formatSubsection}
  ...
  \newcommand{\formatChapter}[1]{%
    \begin{tikzpicture}[remember picture,overlay]
      \node[yshift=-3cm] at (current page.north west)
        {\begin{tikzpicture}[remember picture, overlay]
          \draw[fill=dossier@header@colorB] (0,0) rectangle
            (\paperwidth,3cm);
          \node[anchor=east,xshift=.9\paperwidth,rectangle,
                rounded corners=2pt,inner sep=11pt,
                fill=dossier@header@colorB!80]
...
\newcommand{\parttoccolor}{dossier@header@colorB}
\newcommand{\chaptertoccolor}{dossier@header@colorB}
\newcommand{\sectiontoccolor}{general@best@teal}
\newcommand{\subsectiontoccolor}{general@best@orange}
