...
\titleformat{\section}
  {\Large\bfseries\sffamily\color{ds@cappucino@a}}
  {\SectionNumberBox{section}{ds@cappucino@a}}
  {0pt}
  {\formatSection}
\titleformat{\subsection}
  {\large\bfseries\sffamily\color{ds@cappucino@b}}
  {\SectionNumberBox{subsection}{ds@cappucino@b}}
  {0pt}
  {\formatSubsection}
  ...
  \newcommand{\formatChapter}[1]{%
    \begin{tikzpicture}[remember picture,overlay]
      \node[yshift=-3cm] at (current page.north west)
        {\begin{tikzpicture}[remember picture, overlay]
          \draw[fill=ds@cappucino@d] (0,0) rectangle
            (\paperwidth,3cm);
          \node[anchor=east,xshift=.9\paperwidth,rectangle,
                rounded corners=2pt,inner sep=11pt,
                fill=ds@cappucino@d!80]
...
\newcommand{\sectiontoccolor}{ds@cappucino@a}
\newcommand{\subsectiontoccolor}{ds@cappucino@b}
