...
\newcommand{\formatchapter}[1]{%
	\begin{tikzpicture}[remember picture,overlay]
		...
		\node[anchor=west,xshift=4.3cm,yshift=1.25cm, rectangle, rounded corners=8pt,inner sep=30pt, fill=easi@default@blue, minimum width=.76\paperwidth] {\color{white} #1};
		\end{tikzpicture}
		};
	\end{tikzpicture}
}
