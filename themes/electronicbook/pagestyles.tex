...
%\titleformat{name=\chapter,numberless}[display]
	...
	{\begin{tikzpicture}[remember picture,overlay]
		...
		%\node[anchor=west,xshift=4.3cm,yshift=1.25cm, rectangle, rounded corners=12pt,inner sep=30pt, fill=easi@light@blue, minimum width=.76\paperwidth] {\color{white}\thechapter~-~#1};
		\end{tikzpicture}
		};
	\end{tikzpicture}
	}
