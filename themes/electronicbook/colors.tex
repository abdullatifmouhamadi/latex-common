...
%\definecolor{pagenumber@bg@color}		{cmyk}{.94,0.37,0,0.17} original
...
%\definecolor{section@title@color}		{cmyk}{1,0.2,0.3,0.1} original
\definecolor{section@title@color}		{RGB}{0,31,63}
%\definecolor{subsection@title@color}		{cmyk}{0,0.6,0.9,0} original
\definecolor{subsection@title@color}		{RGB}{0, 116, 217}
%\definecolor{subsubsection@title@color}	{cmyk}{0.71,0,0.87,0.35} original
...
%\definecolor{activitytitle@color}		{cmyk}{0.25,0.85,0,0.38} % original
