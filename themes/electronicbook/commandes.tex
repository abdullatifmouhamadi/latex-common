...
\fill[fill=shadow@color] ($(texte.south west)+(1pt,-1pt)$) -- ($(texte.north west)+(1pt,-1pt)$) -- ($(texte.north east)+(1pt,-1pt)$) -- ($(texte.south east)+(0,6.5pt)+(1pt,-2pt)$) .. controls ($(texte.south east)+(-2pt,2pt)+(1pt,-1pt)$) and ($(texte.south east)+(-3pt,1pt)+(1pt,-1pt)$) .. ($(texte.south east)+(-6.5pt,0)+(1pt,-1pt)$) -- cycle;
\fill[fill=rem@bg@color!25] (texte.south west) -- (texte.north west) -- (texte.north east) -- ($(texte.south east)+(0,5pt)$) -- ($(texte.south east)+(-5pt,0)$) -- cycle;
\fill[fill=shadow@color!50!black] ($(texte.south east)+(0,5pt)$) .. controls ($(texte.south east)+(-2pt,2pt)$) and ($(texte.south east)+(-3pt,1pt)$) .. ($(texte.south east)+(-5pt,0)$) .. controls ($(texte.south east)+(-4.5pt,2.5pt)$) .. ($(texte.south east)+(-5pt,5pt)$) .. controls ($(texte.south east)+(-2.5pt,4.5pt)$) .. ($(texte.south east)+(0,5pt)$);
...
\fill[fill=shadow@color] ($(texte.south west)+(1pt,-1pt)$) -- ($(texte.north west)+(1pt,-1pt)$) -- ($(texte.north east)+(1pt,-1pt)$) -- ($(texte.south east)+(0,6.5pt)+(1pt,-2pt)$) .. controls ($(texte.south east)+(-2pt,2pt)+(1pt,-1pt)$) and ($(texte.south east)+(-3pt,1pt)+(1pt,-1pt)$) .. ($(texte.south east)+(-6.5pt,0)+(1pt,-1pt)$) -- cycle;
\fill[fill=meth@bg@color!25] (texte.south west) -- (texte.north west) -- (texte.north east) -- ($(texte.south east)+(0,5pt)$) -- ($(texte.south east)+(-5pt,0)$) -- cycle;
\fill[fill=shadow@color!50!black] ($(texte.south east)+(0,5pt)$) .. controls ($(texte.south east)+(-2pt,2pt)$) and ($(texte.south east)+(-3pt,1pt)$) .. ($(texte.south east)+(-5pt,0)$) .. controls ($(texte.south east)+(-4.5pt,2.5pt)$) .. ($(texte.south east)+(-5pt,5pt)$) .. controls ($(texte.south east)+(-2.5pt,4.5pt)$) .. ($(texte.south east)+(0,5pt)$);
...
{%
	...
	\begin{tikzpicture}
	\node[fill=def@bg@color!25] (texte) {\usebox{\def@box}};
...
{%
	...
	\begin{tikzpicture}
	\node[fill=prop@bg@color!25] (texte) {\usebox{\prop@box}};
...
{%
	...
	\begin{tikzpicture}
	\node[fill=thm@bg@color!25] (texte) {\usebox{\thm@box}};
...
{%
	...
	\begin{tikzpicture}
	\node[fill=ex@bg@color!25] (texte) {\usebox{\ex@box}};
...
{%
	...
	\begin{tikzpicture}
	\fill[shadow@color] (0.02,-.02) circle[x radius=1.5em,y radius=1.0em,rotate=0];
	\fill[activitytitle@color,rotate=0] (0,0) circle[x radius=1.5em,y radius=1.0em];
...
{%
	...
	\pagecolor{exercices@bg@color!32}
	\begin{flushright}
	\begin{tikzpicture}
	\node[inner sep=1em] (titre) {\exercicetitle@font Exercices};
	\fill[rounded corners=2pt,fill=shadow@color] ($(titre.north west)+(1pt,-1pt)$) -- ($(titre.north east)+(1mm,0mm)+(1pt,-1pt)$) -- ($(titre.south east)+(1pt,-1pt)$) -- ($(titre.south west)+(-1mm,0)+(1pt,-1pt)$) -- cycle;
...
{%
	\newpage
	%\pagecolor{corriges@bg@color} original
	\pagecolor{corriges@bg@color!32}
	\begin{flushright}
	\begin{tikzpicture}
