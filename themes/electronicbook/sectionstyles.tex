...
\fill[rounded corners=2pt,fill=shadow@color] ($(numsec.north west)+(1pt,-1pt)$) -- ($(numsec.north east)+(1mm,0mm)+(1pt,-1pt)$) -- ($(numsec.south east)+(1pt,-1pt)$) -- ($(numsec.south west)+(-1mm,0)+(1pt,-1pt)$) -- cycle;
