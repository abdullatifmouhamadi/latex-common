...
\usepackage{lipsum}
\title{Documentation de la classe mathbook.cls v1.4}
...
Dans l'exemple des corrections d'exercices qui vient, j'ai utilisé le code suivant pour l'exercice 3 :
...
\paragraph*{26 mai 2019.} Ajout de la commande \textbackslash BreakCorr qui permet d'insérer un saut de page dans un corrigé si ce dernier ne tient pas sur une seule page (ou \textbackslash BreakCorr[\textbackslash columnbreak] si on est dans un environnement multi-colonnes).
